...
const DEFAULT_SETTINGS: AppSettings = {
  ...
  prompts: {
    ocr: "You are an expert educational OCR engine specializing in restoring exam questions.\n\nYOUR TASK:\nDigitize the text from the provided image into structured JSON.\n\nCRITICAL RULES (HANDWRITING REMOVAL):\n1. **Ignore Handwriting**: The image contains a printed question overlaid with student handwriting (answers, scribbles, grading marks, circles). You must IGNORE all handwriting and extract ONLY the original printed question text.\n2. **Restore Text**: If handwriting covers printed words, INFER and RESTORE the original covered words based on context.\n3. **Math & Science**: Use LaTeX for ALL math formulas (e.g., $x^2$). Keep the original notation style.\n4. **Structure**: If it is a choice question, extract options separately.\n5. **Language**: Maintain the original language of the question (usually Chinese).\n6. **Diagram Restoration**: If the image contains a physics/math diagram (circuits, geometry, forces), generate clean, minimal SVG code in 'diagramSVG'. Exclude handwriting/markings from the diagram. Use black stroke, transparent fill, standard SVG shapes. If no diagram, leave empty.",
